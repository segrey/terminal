...
public:
    ...
    bool CursorUp(const int /*distance*/) noexcept override { return false; } // CUU
    bool CursorDown(const int /*distance*/) noexcept override { return false; } // CUD
    bool CursorForward(const int /*distance*/) noexcept override { return false; } // CUF
    bool CursorBackward(const int /*distance*/) noexcept override { return false; } // CUB, BS
    bool CursorNextLine(const int /*distance*/) noexcept override { return false; } // CNL
    bool CursorPrevLine(const int /*distance*/) noexcept override { return false; } // CPL
    bool CursorHorizontalPositionAbsolute(const int /*column*/) noexcept override { return false; } // HPA, CHA
    bool VerticalLinePositionAbsolute(const int /*line*/) noexcept override { return false; } // VPA
    bool HorizontalPositionRelative(const int /*distance*/) noexcept override { return false; } // HPR
    bool VerticalPositionRelative(const int /*distance*/) noexcept override { return false; } // VPR
    bool CursorPosition(const int /*line*/, const int /*column*/) noexcept override { return false; } // CUP, HVP
    ...
    bool InsertCharacter(const int /*count*/) noexcept override { return false; } // ICH
    bool DeleteCharacter(const int /*count*/) noexcept override { return false; } // DCH
    bool ScrollUp(const int /*distance*/) noexcept override { return false; } // SU
    bool ScrollDown(const int /*distance*/) noexcept override { return false; } // SD
    bool InsertLine(const int /*distance*/) noexcept override { return false; } // IL
    bool DeleteLine(const int /*distance*/) noexcept override { return false; } // DL
    bool SetColumns(const int /*columns*/) noexcept override { return false; } // DECCOLM
    ...
    bool SetTopBottomScrollingMargins(const int /*topMargin*/, const int /*bottomMargin*/) noexcept override { return false; } // DECSTBM
    ...
    bool ForwardTab(const int /*numTabs*/) noexcept override { return false; } // CHT, HT
    bool BackwardsTab(const int /*numTabs*/) noexcept override { return false; } // CBT
    ...
    bool EraseCharacters(const int /*numChars*/) noexcept override { return false; } // ECH
    ...
    bool Designate94Charset(const int /*gsetNumber*/, const VTID /*charset*/) noexcept override { return false; } // SCS
    bool Designate96Charset(const int /*gsetNumber*/, const VTID /*charset*/) noexcept override { return false; } // SCS
    bool LockingShift(const int /*gsetNumber*/) noexcept override { return false; } // LS0, LS1, LS2, LS3
    bool LockingShiftRight(const int /*gsetNumber*/) noexcept override { return false; } // LS1R, LS2R, LS3R
    bool SingleShift(const int /*gsetNumber*/) noexcept override { return false; } // SS2, SS3
