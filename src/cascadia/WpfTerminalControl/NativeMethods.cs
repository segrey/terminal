...
#pragma warning disable SA1600 // Elements should be documented
    internal static class NativeMethods
    {
        ...
        public enum SetWindowPosFlags : uint
        {
            ...
            /// <summary>
            ///     Applies new frame styles set using the SetWindowLong function. Sends a WM_NCCALCTilSize message to the window, even if the window's size is not being changed. If this flag is not specified, WM_NCCALCTilSize is sent only when the window's size is being changed.
            /// </summary>
