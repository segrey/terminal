...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT PaintBufferLine(gsl::span<const Cluster> const clusters, const til::point coord, const bool fTrimLeft, const bool lineWrapped) noexcept override;
